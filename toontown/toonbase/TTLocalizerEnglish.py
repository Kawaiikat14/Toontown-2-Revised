...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 12100: ('to the', 'in the', 'Cashbot HQ Vault Lobby'),
...
NPCFriendPageDeleteConfirmation = 'Are you sure you want to delete one of these SOS cards?'
...
PatternGameTitle = 'Match Kion'
PatternGameInstructions = 'Kion will show you a dance sequence. ' + "Try to repeat Kion's dance just the way you see it using the arrow keys!"
...
MinigameSurfersTitle = 'Mint Runner'
MinigameSurfersInstructions = 'Run through the Mint using the arrow keys! Collect as many jellyeans as you can and avoid getting caught by the evil Cog!'
SurfersMap = 'Map'
SurfersRadar = 'Radar'
SurfersYouFell = 'You Fell!'
SurfersSpeedup = 'Speed-up'
SurfersTax = 'You ran out of time! The Cog stole half of your jellybeans!'
SurfersCogReach = 'The Cog reached you!'
